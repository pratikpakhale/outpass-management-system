    ...
    <>
      <div className='mt-10 px-10'>
        ...
        <div className='flex justify-end items-center font-ubuntu text-lg w-full'>
          <Link to={'/slc/manage/students/add'}>
        ...
        <div className='flex flex-col items-center mt-4'>
          <div className=' flex items-center text-xl text-white bg-ezpass rounded-full h-8 px-1 py-6 my-4 w-5/6'>
            ...
            <div className='w-1/4 md:text-center'>Faculty Advisor</div>
          ...
          {students.map(student => (
            ...
            >
              <div className='w-1/4 md:text-center'>{student.name}</div>
              <div className='w-1/4 md:text-center'>{student.email}</div>
              ...
              <div className='w-1/4 md:text-center flex justify-center items-center'>
                <Link
                  to={'/slc/manage/students/edit/' + student._id}
                  className=''
                >
