...
function EditFacultyAdvisor() {
  ...
  const { email } = facultyAdvisor

  const getFacultyAdvisor = useCallback(async () => {
    const res = await fetch(
      '/.netlify/functions/app/slc/facultyAdvisors/' + id,
      {
        method: 'GET',
        headers: {
    ...
    setName(data.facultyAdvisor.name)
    setPhoneNumber(data.facultyAdvisor.phoneNumber)
    setProfileUrl(data.facultyAdvisor.profileUrl)
  }, [id, setFacultyAdvisor])
...
export default EditFacultyAdvisor
